						  ...
						  <form action='' method="post">
							<table border="0" width="100%" height="131">
							 ...
							 <tr>
							   ...
							   <tr>
							    <td  class="font14" colspan="2">审批时间 <input name="tbDate" class="easyui-datebox" data-options = "editable:false" id="tbDate" type="text" style="width:90px;" /> 至 <input name="tbDateE" id="tbDateE" class="easyui-datebox" data-options = "editable:false" type="text" style="width:90px;" />
