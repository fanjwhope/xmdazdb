...
<div data-options="region:'north',border:false" style="overflow:hidden;background:ButtonFace;">
	<table style="width:100%;height:37px;border:1px solid #A9A9A9;" cellspacing="0" cellpadding="0">
		<tr>
			...
			<td nowrap="true" style="width:55px;height:37px;" onmouseover="this.className='tdover'" onmouseout="this.className='tddefault'" onClick="goUrl('../logInfo.jsp');"><img align="absmiddle" src="../images/top_icon8.gif" width="24" height="24"  border="0"  >日志管理</td>
			<td nowrap="true" style="width:55px;height:37px;" onmouseover="this.className='tdover'" onmouseout="this.className='tddefault'" onClick="goUrl('../pwdManage.jsp');"><img align="absmiddle" src="../images/top_icon7.gif" width="24" height="24"  border="0"  >修改口令</td>
			<td nowrap="true" style="width:55px;height:37px;" onmouseover="this.className='tdover'" onmouseout="this.className='tddefault'" onclick="closeWind();"><img align="absmiddle"  src="../images/top_icon9.gif" width="24" height="23" border="0" >&nbsp;关 闭</td>
			<td>&nbsp;</td>
		</tr>
	</table>
...
<script language="javascript">
	...
	function goZD(){
		window.location.href="<%=cxt%>/pages/systemMenu.jsp?zdbdbName=zdb";
	}  
	function closeWind(){
