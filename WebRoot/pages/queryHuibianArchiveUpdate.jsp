...
<html>
  <head>
    ...
    function addStdNr(){
        	...
        	var uri;
        	if('<%=yjflag%>'=='2'||"1"=='<%=type%>'){
        		$('#load').attr('src',"<%=cxt%>/pages/achiveDirectoryShow.jsp?zdbdbName=<%=zdbdbName%>&archiveType="+archiveType+"&lsh="+lsh);
        	}else{
           	 $.ajax({
           		 type:'post',
    ...
    <td width="660px" bgcolor="#C0C0C0" valign="middle" bordercolor="#C0C0C0" bordercolorlight="#C0C0C0" align="center">
      <table border="0" width="660px">
        <tr>
          ...
          <td style="width:120px" align="left"><font color="#000080">卷&nbsp;中方实施单位</td>
    ...
    <td width="660px" bgcolor="#C0C0C0" valign="middle" bordercolor="#C0C0C0" bordercolorlight="#C0C0C0" align="center">
      <table border="0" width="660px">
        <tr>
        	...
        	<td style="width:76px" align="right"><font color="#000080">审批时间</td>
         ...
         <hr>
            <tr>
              <td  align='middle'>
                     ...
                     <input type='button' name='button'  class="button" value='选 择' onclick="addStdNr()"><%if("2".equals(yjflag)||"1".equals(type)){}else{%>&nbsp;<input type="button" class="button" value="存 盘" name="okwjzla" id="okwjzla"   onclick="SubmitCheck()">&nbsp;<input type="button" name='squares' id="squares" class="button" value="结 清" onclick="square()"><%}%>&nbsp;<input type="button"  class="button"  value="关 闭" name="okprev" id="okprev"  onclick="clo()">			    
				</td>
            </tr>
          </table>
</td>
