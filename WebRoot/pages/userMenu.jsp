...
<input type="hidden" value="zd" id="zyorzd">
<div data-options="region:'north',border:false" style="overflow:hidden;background:ButtonFace;">
	<table  nowrap="true" style="width:100%;height:37;background:ButtonFace;border:2px groove;" cellspacing="0">
		<tr >
			...
			<% if("1".equals(roles)||"2".equals(roles)||"4".equals(roles)) {%>
			<td nowrap="true" class="tddefault" style="width:82px;height:37px;" onmouseover="this.className='tdover'" onmouseout="this.className='tddefault'" onClick="goUrl('archiveAddZD.jsp');"><img align="absmiddle" src="../images/top_icon1.gif" width="24" height="24"  border="0"  >项目著录</td>
			<td nowrap="true" class="tddefault" style="width:82px;height:37px;" onmouseover="this.className='tdover'" onmouseout="this.className='tddefault'" onClick="goUrl('ProjectInfo-old.jsp');"><img align="absmiddle" src="../images/top_icon5.gif" width="24" height="24"  border="0"  >项目说明</td>
			...
			<td nowrap="true" class="tddefault" style="width:82px;height:37px;" onmouseover="this.className='tdover'" onmouseout="this.className='tddefault'" onClick="goUrl('../queryHuiBianZD.jsp');"><img align="absmiddle" src="../images/top_icon4.gif" width="24" height="24"  border="0"  >项目查询</td>
			...
			<td nowrap="true" class="tddefault" style="width:82px;height:37px;" onmouseover="this.className='tdover'" onmouseout="this.className='tddefault'" onClick="goUrlws('webSearchZD.jsp?roles=<%=roles%>&zdbdbName=zdb');"><img align="absmiddle" src="../images/top_icon8.gif" width="24" height="24"  border="0"  >网上查询</td>
			...
			<%if("4".equals(roles)){%>
			<td nowrap="true" class="tddefault" style="width:82px;height:37px;" onmouseover="this.className='tdover'" onmouseout="this.className='tddefault'" onClick="goUrl('zsrk.jsp');"><img align="absmiddle" src="../images/top_icon10.gif" width="24" height="24"  border="0"  >正式入库</td>
			<td nowrap="true" class="tddefault" style="width:82px;height:37px;" onmouseover="this.className='tdover'" onmouseout="this.className='tddefault'" onclick="goUrl('sjyz.jsp');"><img align="absmiddle"  src="../images/top_icon1.gif" width="24" height="23" border="0" >数据验证</td>
			<%}%>
			<td nowrap="true" class="tddefault" style="width:82px;height:37px;" onmouseover="this.className='tdover'" onmouseout="this.className='tddefault'" onClick="goUrl('sum.jsp');"><img align="absmiddle" src="../images/top_icon10.gif" width="24" height="24"  border="0"  >数据统计</td>
			...
			<td nowrap="true" class="tddefault" style="width:82px;height:37px;" onmouseover="this.className='tdover'" onmouseout="this.className='tddefault'" onClick="goUrlws('webSearch.jsp?roles=<%=roles%>&zdbdbName=zdb');"><img align="absmiddle" src="../images/top_icon6.gif" width="24" height="24"  border="0"  >网上查询</td>
			<td nowrap="true" class="tddefault" style="width:82px;height:37px;" onmouseover="this.className='tdover'" onmouseout="this.className='tddefault'" onClick="goUrl('sum.jsp');"><img align="absmiddle" src="../images/top_icon10.gif" width="24" height="24"  border="0"  >数据统计</td>
...
<script language="javascript">
	...
	function goUrl(url){
		$('#frameMain').attr("src",url+'?zdbdbName=zdb');
	}  
	function goUrlws(url){
		$('#frameMain').attr("src",url);
	}  
	function goZY(){
		window.location.href="<%=cxt%>/pages/userMenuZY.jsp?zdbdbName=zdbzy";
	}  
