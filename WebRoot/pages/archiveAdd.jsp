...
<html>
      ...
      $(function(){
        	...
        	$('#select').combobox({ 
        	    ...
        	    formatter:function(row){
        	    	...
        	    	if(row.flag=='0'){
        	    		str='<span><font color="#FF0000" size="2">{1}</font></span>';
        	    	}else{
        	    		str='<span><font color="#00FF00" size="2" >{1}</font></span>';
        	    	} 
    ...
    function  SubmitDelete(){
     ...
     function SubmitDiwei(){
    	...
    	if(dingwei==0){
         ...
         //选择功能，为卷内容编写目录
    function addStdNr(){
        	var archiveType=$('#select').combobox('getValue');
        		...
        		alert("请选择贷款内容！");
		        	...
		        	if(lsh){
			        	...
			        	var url;
			        	 $.ajax({
			        		 type:'post',
			        	     url:'<%=cxt%>/do/ArchiveDo/isNotStand?archiveType='+archiveType+'&lsh='+lsh,
			        	     dataType:'json',
			        	     success:function(data){
			        	    	 if(data.param==1){//非标准
			        	    		 $('#load').attr('src',"<%=cxt%>/pages/achiveDirectory.jsp?zdbdbName=<%=zdbdbName%>&archiveType="+archiveType+"&lsh="+lsh+"&type="+select);
			        	    	 }else{
  ...
  <div data-options="region:'center',border:false" style="overflow:hidden;background:#ffffff">
  <div id="listPage" style="width:100%;height:100%;padding:20px;margin:0px;">
 ...
 <table border="3" width="660px" cellpadding="0" cellspacing="0" bgcolor="#FFFFE8"  bordercolordark="#333399"  bordercolorlight="buttonface" >
  ...
  <tr>
    <td width="660px" bgcolor="#C0C0C0" bordercolor="#C0C0C0" bordercolorlight="#C0C0C0" align="center">
      <table border="0" width="660px">
        <tr>
          <td style="width:130px" align="center"><font color="#000080">借款人/客户名称</font></td>
          ...
          <td style="width:60px" align="right"><font color="#000080">&nbsp;信贷员</font></td>
  ...
  <tr>
    <td width="660px" bgcolor="#C0C0C0" valign="middle" bordercolor="#C0C0C0" bordercolorlight="#C0C0C0" align="center">
      <table border="0" width="660px">
        <tr>
          <td style="width:76px" align="right"><font color="#000080">项 目名 称</font></td>
  ...
  <tr>
    ...
    <td width="660px" bgcolor="#C0C0C0" valign="middle" bordercolor="#C0C0C0" bordercolorlight="#C0C0C0" align="center">
      <table border="0" width="660px">
        <tr>
          <td style="width:86px" align="right"><font color="#000080">借款合同号</font></td>
          ...
          <td style="width:120px" align="left"><font color="#000080">卷&nbsp;中方实施单位</font></td>
  ...
  <tr>
    <td width="660px" bgcolor="#C0C0C0" valign="middle" bordercolor="#C0C0C0" bordercolorlight="#C0C0C0" align="center">
      <table border="0" width="660px">
        <tr>
        	<td style="width:88px" align="right"><font color="#000080">担 保方 式</font></td>
        	<td style="width:228px" ><input type="text" name="bz" id="bz"  style="width:218px" /></td>
        	<td style="width:55px" align="right"><font color="#000080">保证人</font></td>
        	<td style="width:160px"><input type="text" name="by1" id="by1" style="width:150px"  /></td>
        	<td style="width:36px" align="right"><font color="#000080">利率</font></td>
  ...
  <tr>
    <td width="660px" bgcolor="#C0C0C0" valign="middle" bordercolor="#C0C0C0" bordercolorlight="#C0C0C0" align="center">
      <table border="0" width="660px">
        <tr>
        	<td style="width:84px" align="right"><font color="#000080">档 案编 号</font></td>
  ...
  <tr>
    <td width="660px" bgcolor="#C0C0C0" valign="middle" bordercolor="#C0C0C0" bordercolorlight="#C0C0C0" align="center">
      <table border="0" width="660px">
        <tr>
        	<td style="width:78px" align="right"><font color="#000080">立卷时间</font></td>
        	<td style="width:150px" align="left"> <input type="text" name="ljDate"  id="ljDate" class="easyui-datebox" style="width: 150px;" /></td>
        	<td style="width:100px;">&nbsp;</td>
        	<td style="width:76px" align="right"><font color="#000080">审批时间</font></td>
  ...
  <tr>
    <td width="660px" bgcolor="#C0C0C0" height="19" bordercolor="#C0C0C0" bordercolorlight="#C0C0C0">
      <p align="center">
         ...
         <hr>
          <tr>
            <td width="500px" align="right">
             <input type="button" class="button" value="著 录" name="okzl"  id="okzl" onclick="zhulu()" /><input type="button" class="button" value="存 盘" name="okwjzla" id="okwjzla"   onclick="SubmitCheck()"/><input type="button" class="button"  value="删 除" name="okdelete" id="okdelete"  onclick="SubmitDelete()" /><input type="button"   class="button" value="下 移"   name="oknext" id="oknext"  onclick="SubmitNext()"/><input type="button"  class="button"  value="上 移" name="okprev" id="okprev"  onclick="SubmitPrev()"/><input type="reset" class="button" value="重 写"  name="cancelwjzl"  id="cancelwjzl"/><input  name="okdiwei" id="okdiwei"   onclick="SubmitDiwei()" type="button" class="button" value="定 位"  /></td> 
            <td width="130px"><div id="dwdiv" style="width:130;color: #000099;display:None">协议号<input name="htbh" id="htbh" size="8" /></div></td>
            </tr>
            <tr>
              <td colspan="2" width="660px" align="center">
                            贷款内容   <input type="text"  id="select"  name="select" style="width:250px;" />
                 <input type='button' name='button'  class="button" value="选 择" onclick="addStdNr()"/><input type="button" name='squares' id="squares" class="button" value="结 清" onclick="square()" />			    
				</td>
            </tr>
          </table>
  </td>
	 ...
	 <div id="rightDiv" style="height: 150px;width:200px;float: right">
	   ...
	   <div id="tail" style="height: 25px;width:280px;float: inherit" align="center">
	         <input type="button" id="bzsSave" name="bzsSave" value="保存" onclick="saveJe()">&#12288;&#12288;&#12288; 
	              <input type="button" id="bzsCal" name="bzsCal" value="关闭" onclick="col()"> 
	   </div>
 </div> 
  </body>
</html>
