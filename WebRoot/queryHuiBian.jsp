  ...
  <head>
    ...
    <script type="text/javascript">
        ...
        function showForm(lsh,xmbh,yjflag){
        	/* if(yjflag==2){
        		$('#load').attr('src','pages/queryHuibianArchiveShow.jsp?lsh='+lsh+'&xmbh='+xmbh+'&yjflag='+yjflag);
        	}else{ */
        	    $('#load').attr('src','pages/queryHuibianArchiveUpdate.jsp?zdbdbName=<%=zdbdbName%>&lsh='+lsh+'&xmbh='+xmbh+'&yjflag='+yjflag);
        	// } 
        	$('#listPage').hide();
    		$('#modifyPage').show(); 
        }
